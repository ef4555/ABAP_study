# 09/05 yh5(코드 정리, 루프 clear 수정)

생성자: 최예훈
생성 일시: 2023년 9월 5일 오전 9:33
태그: 실습

여러 개 상위자재 하위자재가 동시에 변경되면 오류나타나는 현상 해결

원래는 명세서 상 한계인 줄 알았음

LOOP 돌 때 구조체와 인터널 테이블 모두를 CLEAR해야하는데 구조체만 비워서 생긴 문제 → 상식적으로 각각 변경하면 되는데 둘 다 변경하면 안된다는게 이상했다.

이런 경우 보통 루프에서 값이 남아있어서 생기는 문제

그리고 clear는 루프 내부에서 돌때마다 해줘야함

확실히 헤더라인을 쓰면 편한데 헷갈린다.
...
![Untitled](09%2005%20yh5(%E1%84%8F%E1%85%A9%E1%84%83%E1%85%B3%20%E1%84%8C%E1%85%A5%E1%86%BC%E1%84%85%E1%85%B5,%20%E1%84%85%E1%85%AE%E1%84%91%E1%85%B3%20clear%20%E1%84%89%E1%85%AE%E1%84%8C%E1%85%A5%E1%86%BC)%20bf1219bf9171436987ae4a7f85322ed4/Untitled.png)

- Main ALV

![Untitled](09%2005%20yh5(%E1%84%8F%E1%85%A9%E1%84%83%E1%85%B3%20%E1%84%8C%E1%85%A5%E1%86%BC%E1%84%85%E1%85%B5,%20%E1%84%85%E1%85%AE%E1%84%91%E1%85%B3%20clear%20%E1%84%89%E1%85%AE%E1%84%8C%E1%85%A5%E1%86%BC)%20bf1219bf9171436987ae4a7f85322ed4/Untitled%201.png)

- 수정 모드

![Untitled](09%2005%20yh5(%E1%84%8F%E1%85%A9%E1%84%83%E1%85%B3%20%E1%84%8C%E1%85%A5%E1%86%BC%E1%84%85%E1%85%B5,%20%E1%84%85%E1%85%AE%E1%84%91%E1%85%B3%20clear%20%E1%84%89%E1%85%AE%E1%84%8C%E1%85%A5%E1%86%BC)%20bf1219bf9171436987ae4a7f85322ed4/Untitled%202.png)

- 더블 클릭 시 팝업

![Untitled](09%2005%20yh5(%E1%84%8F%E1%85%A9%E1%84%83%E1%85%B3%20%E1%84%8C%E1%85%A5%E1%86%BC%E1%84%85%E1%85%B5,%20%E1%84%85%E1%85%AE%E1%84%91%E1%85%B3%20clear%20%E1%84%89%E1%85%AE%E1%84%8C%E1%85%A5%E1%86%BC)%20bf1219bf9171436987ae4a7f85322ed4/Untitled%203.png)
...
*   CBO 테이블 형식으로 변환
  ...
  METHOD handle_double_click. " 더블 클릭 시 팝업 ALV
    CALL SCREEN 110 STARTING AT 10 10."handle_double_click
  ENDMETHOD.
...
*  해당 자재의 상위 자재의stlnr로 BOM 헤더 데이터 가져옴
    ...
    CALL FUNCTION 'CSAP_MAT_BOM_MAINTAIN'
      ...
      IF sy-subrc EQ 1.
        ...
        CONCATENATE lv_text ' ' lv_menge_text ' 로 변경시 에러 발생' INTO lv_text RESPECTING BLANKS. "변경 에러 발생 시 코멘트
...
FORM reselect_data .
  ...
  PERFORM sel_bom_data.     " 조건값에 맞는 BOM 정보 조회
  PERFORM bom_expl_loop.    " 조건값 matnr 순회하면서 bom_expl
  MESSAGE '오류 제외하고 변경사항 반영됨' TYPE 'I'.
