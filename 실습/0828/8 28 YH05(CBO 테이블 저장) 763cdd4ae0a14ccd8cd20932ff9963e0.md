# 8/28 YH05(CBO 테이블에 저장)

생성자: 최예훈
생성 일시: 2023년 8월 28일 오후 5:16
태그: 실습
...
FORM update_database . " 실제로 데이터베이스에 저장하는 서브루틴
  DATA : lt_itab TYPE TABLE OF zpp001yh,
         ls_itab TYPE zpp001yh.

  LOOP AT gt_list.
    MOVE-CORRESPONDING gt_list to ls_itab.
    APPEND ls_itab to lt_itab.

  ENDLOOP.
  TRY.
    MODIFY zpp001yh FROM ls_itab.
...
```
 ...
 각 조회값 모품목의 첫번째 자재만 zpp001yh 테이블에 저장되고 있다.

Menge값이 어떤 값은 저장되고 어떤 값은 저장되지 않는 중

값이 선택적으로 들어가는 중

![Untitled](8%2028%20YH05(CBO%20%E1%84%90%E1%85%A6%E1%84%8B%E1%85%B5%E1%84%87%E1%85%B3%E1%86%AF%E1%84%8B%E1%85%A6%20%E1%84%8C%E1%85%A5%E1%84%8C%E1%85%A1%E1%86%BC)%20763cdd4ae0a14ccd8cd20932ff9963e0/Untitled.png)
...
CLASS lcl_event IMPLEMENTATION.
  ...
  METHOD handle_data_changed. " data_change 이벤트가 발생되면 아래 로직을 수행
    ...
    DATA : lt_itab TYPE TABLE OF result_type, " 수정할 딕셔너리 테이블의 구조를 가진 구조체
...
*      " er_data_changed의 mp_mod_rows 메서드를 작동. 변화된 row가 담긴 인터널 테이블의 data refrence가 나온다.
    ...
    LOOP AT <fs> INTO lt_itab. " 바뀐 데이터들이 담긴 필드심볼에서 한 줄 씩 꺼냄
...
* grid에 핸들러를 설정
  ...
  CREATE OBJECT gr_varifier. " 데이터 수정 이벤트 핸들러
...
![Untitled](8%2028%20YH05(CBO%20%E1%84%90%E1%85%A6%E1%84%8B%E1%85%B5%E1%84%87%E1%85%B3%E1%86%AF%E1%84%8B%E1%85%A6%20%E1%84%8C%E1%85%A5%E1%84%8C%E1%85%A1%E1%86%BC)%20763cdd4ae0a14ccd8cd20932ff9963e0/Untitled%201.png)