# 09/06 yh06(변경시 확인 추가)

생성자: 최예훈
생성 일시: 2023년 9월 6일 오후 4:30
태그: 실습

## 화면

![Untitled](09%2006%20yh06(%E1%84%87%E1%85%A7%E1%86%AB%E1%84%80%E1%85%A7%E1%86%BC%E1%84%89%E1%85%B5%20%E1%84%92%E1%85%AA%E1%86%A8%E1%84%8B%E1%85%B5%E1%86%AB%20%E1%84%8E%E1%85%AE%E1%84%80%E1%85%A1)%20dd0ad7e313354e6fbb2e19166300430d/Untitled.png)

- Main ALV

![Untitled](09%2006%20yh06(%E1%84%87%E1%85%A7%E1%86%AB%E1%84%80%E1%85%A7%E1%86%BC%E1%84%89%E1%85%B5%20%E1%84%92%E1%85%AA%E1%86%A8%E1%84%8B%E1%85%B5%E1%86%AB%20%E1%84%8E%E1%85%AE%E1%84%80%E1%85%A1)%20dd0ad7e313354e6fbb2e19166300430d/Untitled%201.png)

- 수정 모드

![Untitled](09%2006%20yh06(%E1%84%87%E1%85%A7%E1%86%AB%E1%84%80%E1%85%A7%E1%86%BC%E1%84%89%E1%85%B5%20%E1%84%92%E1%85%AA%E1%86%A8%E1%84%8B%E1%85%B5%E1%86%AB%20%E1%84%8E%E1%85%AE%E1%84%80%E1%85%A1)%20dd0ad7e313354e6fbb2e19166300430d/Untitled%202.png)

- 더블 클릭 시 팝업

![Untitled](09%2006%20yh06(%E1%84%87%E1%85%A7%E1%86%AB%E1%84%80%E1%85%A7%E1%86%BC%E1%84%89%E1%85%B5%20%E1%84%92%E1%85%AA%E1%86%A8%E1%84%8B%E1%85%B5%E1%86%AB%20%E1%84%8E%E1%85%AE%E1%84%80%E1%85%A1)%20dd0ad7e313354e6fbb2e19166300430d/Untitled%203.png)

- 변경 버튼 눌렀을 때 확인

![Untitled](09%2006%20yh06(%E1%84%87%E1%85%A7%E1%86%AB%E1%84%80%E1%85%A7%E1%86%BC%E1%84%89%E1%85%B5%20%E1%84%92%E1%85%AA%E1%86%A8%E1%84%8B%E1%85%B5%E1%86%AB%20%E1%84%8E%E1%85%AE%E1%84%80%E1%85%A1)%20dd0ad7e313354e6fbb2e19166300430d/Untitled%204.png)

- 에러 로그 보기

![Untitled](09%2006%20yh06(%E1%84%87%E1%85%A7%E1%86%AB%E1%84%80%E1%85%A7%E1%86%BC%E1%84%89%E1%85%B5%20%E1%84%92%E1%85%AA%E1%86%A8%E1%84%8B%E1%85%B5%E1%86%AB%20%E1%84%8E%E1%85%AE%E1%84%80%E1%85%A1)%20dd0ad7e313354e6fbb2e19166300430d/Untitled%205.png)

![Untitled](09%2006%20yh06(%E1%84%87%E1%85%A7%E1%86%AB%E1%84%80%E1%85%A7%E1%86%BC%E1%84%89%E1%85%B5%20%E1%84%92%E1%85%AA%E1%86%A8%E1%84%8B%E1%85%B5%E1%86%AB%20%E1%84%8E%E1%85%AE%E1%84%80%E1%85%A1)%20dd0ad7e313354e6fbb2e19166300430d/Untitled%206.png)

## MAIN

```abap
*&---------------------------------------------------------------------*
*& Report  ZPPR_BOM_YH06
*&
*&---------------------------------------------------------------------*
*&
*&
...
INCLUDE zppr_bom_yh06_top. " DATA 정의
INCLUDE zppr_bom_yh06_cls. " CLASS 정의
INCLUDE zppr_bom_yh06_scr. " 1000번 스크린(조회 조건 화면)
INCLUDE zppr_bom_yh06_pbo. " 스크린 100번, 110번의 PBO
INCLUDE zppr_bom_yh06_pai. " 스크린 100번, 110번의 PAI
INCLUDE zppr_bom_yh06_frm. " 서브루틴 정리
...
*----------------------------------
    ...
    METHODS : handle_double_click
          FOR EVENT double_click OF cl_gui_alv_grid  "  cl_gui_alv_grid에 정의된 double_click 이벤트를 감지
                   IMPORTING e_row
                             e_column.

    METHODS : handle_hotspot_click
          FOR EVENT hotspot_click OF cl_gui_alv_grid "  cl_gui_alv_grid에 정의된 hotspot_click 이벤트를 감지
                   IMPORTING e_row_id
                             e_column_id
                             es_row_no.
...
*   er_data_changed의 mp_mod_rows 메서드를 작동. 변화된 row가 담긴 인터널 테이블의 data refrence가 나온다.
    ...
    CLEAR : zpp001yh.
*   CBO 테이블 형식으로 변환
    LOOP AT <fs> INTO ls_str.
      MOVE-CORRESPONDING ls_str TO zpp001yh.
  ...
  METHOD handle_double_click. " 더블 클릭 시 팝업 ALV
    CALL SCREEN 110 STARTING AT 60 10."handle_double_click
  ENDMETHOD.

  METHOD handle_hotspot_click.
    PERFORM evnt_hotspot_click1
                     USING e_row_id
                           e_column_id
                           es_row_no.
...
SELECTION-SCREEN BEGIN OF BLOCK sel_02 WITH FRAME TITLE text-002 NO INTERVALS.

PARAMETERS : p_vari LIKE disvariant-variant.                    " ALV 레이아웃 지정
...
*  아래의 로직을 추가하면 셀을 빠져나가지 않아도  Data Changed Event 가 수행되면서 Internal Table 에 ALV 의 변경된 데이터가 반영되게 된다.
     ...
     IF l_valid IS NOT INITIAL.   " 데이터 변화가 있으면 = l_valid가 'X'면
       ...
       PERFORM check_message  USING '변경 확인' 'BOM 변경 사항을 반영하시겠습니까?' 'YES' 'NO'
                              CHANGING lv_ans.  "  변경 사항 반영 확인 call by reference

        IF lv_ans = '1'.

         PERFORM bom_edit.          " BOM 변경사항 반영
         PERFORM reselect_data.     " ALV 정보 갱신
         PERFORM col_line.          " 라인 색 유지
    ...
    WHEN 'EDITMODE'.
      ...
      PERFORM table_lock.         " 테이블 잠금
      gv_edit_control = 1.        " 수정 모드로 변경
      PERFORM col_line.           " 라인의 색 변경

    WHEN 'REPORTMODE'.
      PERFORM table_unlock.       " 테이블 잠금 해
...
*----------------------------------------------------------------------*
FORM get_werks_name .
  SELECT name1 INTO CORRESPONDING FIELDS OF t001w  " t001w에서 p_werks에 해당하는 작업장 이름 가져옴
    FROM t001w
    WHERE werks = p_werks.
  ENDSELECT.
  ...
  SELECT b~matnr c~maktx a~werks a~stlan a~stlal a~stlnr INTO CORRESPONDING FIELDS OF TABLE it_base
   FROM mast AS a INNER JOIN mara AS b
                  ...
                  INNER JOIN makt AS c
                      ON a~matnr = c~matnr
   WHERE a~werks = p_werks      " 입력받은 작업장
...
*   it_list 헤더라인에 원하는 정보를 담아서 수정
    ...
    it_list-posnr     = it_stpox-posnr.     " BOM 항목 번호
...
* 2.분할한 row에 컨테이너 할당
  CREATE OBJECT gv_splitter
    EXPORTING
      ...
      rows    = 2         " 몇 개의 행으로 나눌것인지
      columns = 1.        " 몇 개의 열로 나눌것인지
...
*     변경한 BOM 데이터
  LOOP AT gt_changed_itab INTO zpp001yh.     " 변경한 데이터
    ...
    CLEAR :tstp3, tstp3[], lt_e_itab, lt_e_itab[].                   " 루프 돌 때마다 초기
...
*   해당 자재의 상위 자재의stlnr로 BOM 헤더 데이터 가져옴
    ...
    CALL FUNCTION 'CSAP_MAT_BOM_MAINTAIN'
      ...
      EXCEPTIONS
        ...
        OTHERS             = 2.
    IF sy-subrc EQ 1.
      lv_error_count = lv_error_count + 1.     " 에러 시 에러 건수 증가
      lt_e_itab-error_name = zpp001yh-ojtxp.   " 에러 난 자재명을 인터널 테이블에 저장
      APPEND lt_e_itab.
    ENDIF.
  ENDLOOP.
  ...
  lv_e_text = lv_error_count.

  CONCATENATE ' 오류 : ' lv_e_text '  건' INTO lv_e_text RESPECTING BLANKS.

  PERFORM check_message  USING '변경 결과' lv_e_text '에러 로그' '확인'
                         CHANGING lv_ans.  "  변경 사항 반영 확인 call by reference

  IF lv_error_count NE 0 AND lv_ans EQ 1. " 에러 발생했을 경우

    CALL FUNCTION 'POPUP_WITH_TABLE_DISPLAY' " 에러 로그 보여줌
      EXPORTING
        endpos_col   = 70
        endpos_row   = 7
        startpos_col = 2
        startpos_row = 1
        titletext    = 'BOM 변경 에러 로그'
      TABLES
        valuetab     = lt_e_itab[]
      EXCEPTIONS
        break_off    = 1
  ...
  ELSEIF lv_error_count = 0 AND lv_ans EQ 1. " 에러 발생하지 않았는데 에러 로그 확인 누른 경우

    CALL FUNCTION 'POPUP_TO_DISPLAY_TEXT'
      EXPORTING
        titel        = '안내'
        textline1    = '에러 로그가 없습니다.'
        start_column = 100
        start_row    = 15.
...
*  <--  p2        text
*----------------------------------------------------------------------*
FORM check_message USING    value(p_title)
                            value(p_question)
                            value(p_button1)
                            value(p_button2)
                   CHANGING value(p_ans).
